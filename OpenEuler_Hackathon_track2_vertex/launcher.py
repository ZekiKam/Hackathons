...
def main():
    while True:
        ...
        if choice == "1":
            ...
            os.system("cd ~/track2_vertex/backend && nohup python3 metrics.py > backend.log 2>&1 &")
        elif choice == "2":
            print("Starting frontend...")
            os.system("cd ~/track2_vertex/frontend && nohup npm run preview -- --host 0.0.0.0 --port 5173 > frontend.log 2>&1 &")
        elif choice == "3":
